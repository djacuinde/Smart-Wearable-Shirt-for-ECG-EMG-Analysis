...
#  define CONF_CLOCK_DPLL_REFERENCE_FREQUENCY     32768	//Crystal Frequency (Hz)
#  define CONF_CLOCK_DPLL_REFERENCE_DIVIDER       1
#  define CONF_CLOCK_DPLL_OUTPUT_FREQUENCY        48000000 //(48MHz)
...
#  define CONF_CLOCK_GCLK_0_ENABLE                false //(Disable internal clock)
...
#  define CONF_CLOCK_GCLK_1_ENABLE                true //(Enable external crystal clock (~32KHz)
